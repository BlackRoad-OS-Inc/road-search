...
AUTH_TOKEN = os.getenv(
    "MCP_BRIDGE_TOKEN",
    "blackroad-road-search-bridge-token",
)
MEMORY_DIR = Path.home() / "blackroad" / "memory" / "road-search"
MEMORY_DIR.mkdir(parents=True, exist_ok=True)

app = FastAPI(title="road-search MCP Bridge")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
@app.get("/")
async def root():
    return {"service": "road-search MCP Bridge", "host": platform.node()}
